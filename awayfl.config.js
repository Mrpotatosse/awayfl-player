...
module.exports = {
	...
	indexTemplate: path.join(__dirname, "node_modules", "@awayfl", "awayfl-player", "template", "index_template.html"), 	//	path to game-html template - must be set
	gameTemplate: path.join(__dirname, "node_modules", "@awayfl", "awayfl-player", "template", "game_template.html"), 	//	path to index-html template - must be set
	loaderTemplate: path.join(__dirname, "node_modules", "@awayfl", "awayfl-player", "template", "loader.js"),	//	path to loader.js - must be set
	...
	resources: ["node_modules/@awayfl/awayfl-player/template/fonts.swf"],	// list of urls to preload (fonts) - relative to project folder
